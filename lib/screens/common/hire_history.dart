...
class _HireHistoryState extends State<HireHistory> {
  ...
  loadPageDetails() async {
    ...
    List<Booking> _ongoing = await dataController.getHiredOngoing(email);
    List<Booking> _completed = await dataController.getHiredCompleted(email);
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "See all the people you have hired here.",
                              style: TextStyle(
                                color: primaryColor,
                                fontSize: 16,
                              ),
